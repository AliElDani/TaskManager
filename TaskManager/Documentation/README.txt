...
Tasks should have the following features (If you think of more add some) :

1. Importance Level
2. Estimated Time to finish
3. Actual Time to finish
4. Description of Tasks (broken down by steps)
5. Due Date
6. Task Name
7. The group(s) it belongs to.
